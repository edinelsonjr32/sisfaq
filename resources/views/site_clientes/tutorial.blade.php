    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <div class="navbar-collapse-header d-md-none">
                <div class="row">
                    <div class="col-md-6 col-sm-12 collapse-brand">
                        <a href="{{ route('home') }}">

                        </a>
                    </div>
                    <div class="col-md-6 col-sm-12 collapse-close">
         ...
         <div class="card-header border-0">
             <div class="row align-items-center">
                 ...
                 <div class="col-md-4 col-sm-12 text-right">
                     ...
                     <a type="button" href="{{route('site.sub_categoria', [$codigo, $idSubCategoria])}}"
                         class="btn btn-primary">
                         Voltar para Sub Catgoria
                     </a>
                 </div>
                                                ...
                                                <div class="card-body card-primary">
                                                    <div class="container">
                                                        ...
                                                        <h2 class="card-title text-center">
                                                            ...
                                                            <br>
                                                            <br>
                                                            <img src="{{ URL::to('/') }}/images/{{ $dado->path_foto}}"
